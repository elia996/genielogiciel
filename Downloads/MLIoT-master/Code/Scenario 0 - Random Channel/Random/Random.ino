...
void loop()
{
  ...
  String myData = String(myPacket) +", I am currently sending r";
  uint8_t data[30];
  myData.toCharArray(data, 30);  
  uint8_t myRand = random(1,4);
  ...
  Serial.println("Sending:" + myData +" to "+randomServer) ;
